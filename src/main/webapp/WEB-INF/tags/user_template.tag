...
<!-- //for-mobile-apps -->
<link href="${pageContext.request.contextPath}/assets/user/css/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- Custom Theme files -->
<link href="${pageContext.request.contextPath}/assets/user/css/style.css" rel='stylesheet' type='text/css' />
<!-- js -->
   <script src="${pageContext.request.contextPath}/assets/user/js/jquery-1.11.1.min.js"></script>
<!-- //js -->
<!-- start-smoth-scrolling -->
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/user/js/move-top.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/user/js/easing.js"></script>
...
<!-- start-smoth-scrolling -->
<link href="${pageContext.request.contextPath}/assets/user/css/font-awesome.css" rel="stylesheet"> 
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Noto+Sans:400,700' rel='stylesheet' type='text/css'>
<!--- start-rate---->
<script src="${pageContext.request.contextPath}/assets/user/js/jstarbox.js"></script>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/user/css/jstarbox.css" type="text/css" media="screen" charset="utf-8" />
		<script type="text/javascript">
			jQuery(function() {
...
<body>
<a href="offer.html"><img src="${pageContext.request.contextPath}/assets/user/images/download.png" class="img-head" alt=""></a>
<div class="header">
								...
								<ul class="dropdown-menu multi">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="kitchen.html"><img src="${pageContext.request.contextPath}/assets/user/images/me.png" class="img-responsive" alt=""></a>
										</div>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="care.html"><img src="${pageContext.request.contextPath}/assets/user/images/me1.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="hold.html"><img src="${pageContext.request.contextPath}/assets/user/images/me2.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
  ...
  <!---->
<div data-vide-bg="${pageContext.request.contextPath}/assets/user/video/video">
    <div class="container">
    ...
    <script>window.jQuery || document.write('<script src="${pageContext.request.contextPath}/assets/user/js/vendor/jquery-1.11.1.min.js"><\/script>')</script>
    <script src="${pageContext.request.contextPath}/assets/user/js/jquery.vide.min.js"></script>
...
<!-- for bootstrap working -->
		<script src="${pageContext.request.contextPath}/assets/user/js/bootstrap.js"></script>
<!-- //for bootstrap working -->
<script type='text/javascript' src="${pageContext.request.contextPath}/assets/user/js/jquery.mycart.js"></script>
  <script type="text/javascript">
  $(function () {
